...
parser.add_argument('--width',     type=int,   default=640,  help='Ancho de PROCESAMIENTO (cam y video; el frame se redimensiona a esto)')
parser.add_argument('--height',    type=int,   default=360,  help='Alto de PROCESAMIENTO (cam y video; el frame se redimensiona a esto)')
